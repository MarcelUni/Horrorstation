...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        // kommenteret walkspeed ud for at kunne redigere uden de ændrer hinanden
        fpc.sprintSpeed = EditorGUILayout.Slider(new GUIContent("Sprint Speed", "Determines how fast the player will move while sprinting."), fpc.sprintSpeed, 2, /*fpc.walkSpeed,*/ 20f);
